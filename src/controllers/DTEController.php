...
class DTEController
{
    ...
    public function crear(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        try {
            ...
            // CORRECCIÓN: Solo validar existencia de cliente si hay cliente_id
            $cliente = null;
            ...
            // Si cliente_id es null, es válido para Factura (consumidor final)
            ...
            $datosDTE = [
                ...
                'dte_relacionado_id' => $data['dte_relacionado_id'] ?? null,
                'subtotal' => $subtotal,
                'iva' => $iva,
                'total' => $total,
                'json_dte' => $jsonDTE,
